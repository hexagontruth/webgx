export default (p) => {
  ...
  return {
    ...
    dataBuffers: [
      p.createDataBuffer(new Float32Array(SIZE ** 2), p.DataBuffer.STORAGE_READ),
    ...
    pipelines: {
      compute: p.createComputePipeline('compute.wgsl', { dataBuffers: [0, 1] }),
      main: p.createRenderPipeline('compute.wgsl', { dataBuffers: [0, 1] }),
    },
  };
};
