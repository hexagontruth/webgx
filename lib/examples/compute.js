  ...
  return {
    ...
    actions: {
      ...
      draw: async () => {
        ...
        p.copyBufferToBuffer(writeBuffer, readBuffer);
        p.draw('main');
        p.render();
      },
    ...
    pipelines: {
      compute: p.createComputePipeline('compute.wgsl', { dataBuffers: [readBuffer, writeBuffer] }),
      main: p.createRenderPipeline('compute.wgsl', { dataBuffers: [readBuffer, writeBuffer] }),
    },
  };
};
