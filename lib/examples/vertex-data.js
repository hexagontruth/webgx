  ...
  return {
    ...
    actions: {
      ...
      draw: async () => {
        ...
        p.controlData.background ? encoder.draw('test') : p.clearTexture(p.drawTexture);
        // encoder.draw('main', p.controlData.shapeCount * 7);
        encoder.drawIndexed('main', indexBuffer, p.controlData.shapeCount * 18);
